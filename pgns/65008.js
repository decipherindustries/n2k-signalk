...
module.exports = [
  {
    ...
    node: function (n2k) { return 'electrical.ac.' + getACLineId(n2k) + '.phase.c.lineNeutralVoltage' }
  },
  {
    source: 'Line-Line AC RMS Voltage',
    node: function (n2k) { return 'electrical.ac.' + getACLineId(n2k) + '.phase.c.lineLineVoltage' }
  },
  {
    source: 'AC Frequency',
    node: function (n2k) { return 'electrical.ac.' + getACLineId(n2k) + '.phase.c.frequency' }
  },
  {
    source: 'AC RMS Current',
    node: function (n2k) { return 'electrical.ac.' + getACLineId(n2k) + '.phase.c.current' }
  }
]
