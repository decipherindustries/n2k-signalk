...
module.exports = [
  {
    ...
    node: function (n2k) { return 'electrical.ac.' + getACLineId(n2k) + '.phase.a.lineNeutralVoltage' }
  },
  {
    source: 'Line-Line AC RMS Voltage',
    node: function (n2k) { return 'electrical.ac.' + getACLineId(n2k) + '.phase.a.lineLineVoltage' }
  },
  {
    source: 'AC Frequency',
    node: function (n2k) { return 'electrical.ac.' + getACLineId(n2k) + '.phase.a.frequency' }
  },
  {
    source: 'AC RMS Current',
    node: function (n2k) { return 'electrical.ac.' + getACLineId(n2k) + '.phase.a.current' }
  }
]
