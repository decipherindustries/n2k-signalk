...
module.exports = [
  {
    ...
    node: function (n2k) { return 'electrical.ac.' + getACLineId(n2k) + '.phase.single.lineNeutralVoltage' }
  },
  {
    source: 'Line-Line AC RMS Voltage',
    node: function (n2k) { return 'electrical.ac.' + getACLineId(n2k) + '.phase.single.lineLineVoltage' }
  },
  {
    source: 'AC Frequency',
    node: function (n2k) { return 'electrical.ac.' + getACLineId(n2k) + '.phase.single.frequency' }
  },
  {
    source: 'AC RMS Current',
    node: function (n2k) { return 'electrical.ac.' + getACLineId(n2k) + '.phase.single.current' }
  }
]
