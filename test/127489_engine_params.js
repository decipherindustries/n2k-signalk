...
describe('127489 engine parameters Port', function () {
  it('every field in the PGN from the NMEA2000 spec converts', function () {
    generatePGNs(
      ...
      tree.should.have.nested.property('propulsion.port.alternatorVoltage.value', 12.6)
      ...
      tree.should.have.nested.property('notifications.propulsion.port.lowOilPressure.value.state', 'alarm')
      tree.should.have.nested.property('notifications.propulsion.port.lowCoolantLevel.value.state', 'alarm')
      tree.should.have.nested.property('notifications.propulsion.port.warningLevel1.value.state', 'alarm')
      tree.should.have.nested.property('notifications.propulsion.port.maintenanceNeeded.value.state', 'alarm')
...
describe('127489 engine parameters Starboard', function () {
  it('every field in the PGN from the NMEA2000 spec converts', function () {
    generatePGNs(
      ...
      tree.should.have.nested.property('propulsion.starboard.alternatorVoltage.value', 12.6)
      tree.should.have.nested.property('propulsion.starboard.fuel.rate')
      tree.should.have.nested.property('propulsion.starboard.fuel.rate.value', 1.1111111111111112e-7)
      ...
      tree.should.have.nested.property('notifications.propulsion.starboard.lowOilPressure.value.state', 'alarm')
      tree.should.have.nested.property('notifications.propulsion.starboard.lowCoolantLevel.value.state', 'alarm')
      tree.should.have.nested.property('notifications.propulsion.starboard.warningLevel1.value.state', 'alarm')
      tree.should.have.nested.property('notifications.propulsion.starboard.maintenanceNeeded.value.state', 'alarm')
      tree.should.be.validSignalKVesselIgnoringIdentity
    })
  })
  ...
  it('engine notifications work', function () {
    generatePGNs(
      ...
      tree.should.have.nested.property('notifications.propulsion.starboard.lowOilPressure.value.state', 'alarm')
      tree.should.have.nested.property('notifications.propulsion.starboard.lowCoolantLevel.value.state', 'normal')
      tree.should.have.nested.property('notifications.propulsion.starboard.warningLevel1.value.state', 'normal')
      tree.should.have.nested.property('notifications.propulsion.starboard.maintenanceNeeded.value.state', 'normal')
      tree.should.be.validSignalKVesselIgnoringIdentity
    })
  })
})
...
describe('127489 engine parameters 2', function () {
  it('every field in the PGN from the NMEA2000 spec converts', function () {
    generatePGNs(
      ...
      tree.should.have.nested.property('propulsion.2.alternatorVoltage.value', 12.6)
      tree.should.have.nested.property('propulsion.2.fuel.rate')
      tree.should.have.nested.property('propulsion.2.fuel.rate.value', 1.1111111111111112e-7)
      ...
      tree.should.have.nested.property('notifications.propulsion.2.lowOilPressure.value.state', 'alarm')
      tree.should.have.nested.property('notifications.propulsion.2.lowCoolantLevel.value.state', 'alarm')
      tree.should.have.nested.property('notifications.propulsion.2.warningLevel1.value.state', 'alarm')
      tree.should.have.nested.property('notifications.propulsion.2.maintenanceNeeded.value.state', 'alarm')
      tree.should.be.validSignalKVesselIgnoringIdentity
    })
  })
