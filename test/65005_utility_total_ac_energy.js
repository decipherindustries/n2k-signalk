...
describe('65005 Utility Total AC Energy', function () {
  it('complete sentence converts', function () {
    ...
    tree.should.have.deep.nested.property('electrical.ac.utility.energyImport.value', 36000000)
    tree.should.have.deep.nested.property('electrical.ac.utility.energyExport.value', 36000000)
