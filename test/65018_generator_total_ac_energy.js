...
describe('65018 Total AC Energy', function () {
  it('complete sentence converts', function () {
    ...
    tree.should.have.nested.property('electrical.ac.generator.energyImport.value', 36000000)
    tree.should.have.nested.property('electrical.ac.generator.energyExport.value', 36000000)
